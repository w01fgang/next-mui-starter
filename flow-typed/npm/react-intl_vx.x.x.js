...
declare module "react-intl" {
  ...
  declare type $npm$ReactIntl$PluralFormatOptions = { style?: "cardinal" | "ordinal", ... };
  ...
  declare type InjectIntlProvidedProps = { intl: $npm$ReactIntl$IntlShape, ... }

  declare type InjectIntlVoidProps = { intl: $npm$ReactIntl$IntlShape | void, ... }
  ...
  declare function useIntl(): IntlShape;
  ...
  declare var RawIntlProvider: React$ProviderExoticComponent<React$ProviderProps<IntlShape>>;
  declare type MessageDescriptor = $npm$ReactIntl$MessageDescriptor;
  declare interface IntlCache {
  ...
  declare type OptionalIntlConfig = Omit<
    IntlConfig,
    $Keys<typeof DEFAULT_INTL_CONFIG>
  > &
    $Rest<typeof DEFAULT_INTL_CONFIG, { ... }>;

  declare function createIntlCache(): IntlCache;
  declare function createIntl(config: OptionalIntlConfig, cache?: IntlCache): IntlShape;
}
