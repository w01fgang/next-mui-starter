...
declare module 'react-relay' {
  ...
  declare export type $FragmentRef<T> = { +$fragmentRefs: $PropertyType<T, '$refType'>, ... };

  // prettier-ignore
  declare export type $RelayProps<Props, RelayPropT = RelayProp> = $ObjMap<
  ...
  declare export function createFragmentContainer<Props: { ... }, TComponent: React.ComponentType<Props>>(
  ...
  > {
     ...
     */
    subscribe(
      snapshot: CSnapshot<TNode, any>, // TODO: fix any
  ...
  declare export function commitLocalUpdate(
    environment: Environment,
  ...
  declare export function fetchQuery<T: OperationType>(
    environment: Environment,
    taggedNode: GraphQLTaggedNode,
  ...
  declare export var ReactRelayContext: React.Context<?RelayContext>;
}
